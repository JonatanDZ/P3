...
- Dernæst tryk "Add tool".

- Pending tool
- For at se et tool der lige er oprettet i pending tool menuen (Bell menu), skal man "logge ind" som en anden bruger.
- For at gøre dette, tilgår man filen i følgende sti: P3/src/main/resources/static/js/getCurrentEmployee.js.
- Her ses en metode, hvor man ændrer argumentet til initialerne på den bruger man vil logge ind som. Her er en bruger for hver department. Dette er vigtigt da pending tools også er filtreret pr. department; altså vil du se det company tool du lige har uploadet, så skal du være logget ind som en ny bruger fra den pågældende department toolet er uploadet til.
  - 'JADE': DevOps,
  - 'BAFR': Frontend,
  - 'MAGA': Games,
  - 'JAPL': Players,

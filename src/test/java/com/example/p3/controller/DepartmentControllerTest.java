...
public class DepartmentControllerTest {
    ...
    public void testGetAllDepartment() throws Exception {
        ...
        //The department are inserted into a list
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/departments"))
                ...
                .andExpect(jsonPath("[0]._dev").value(true)) //IDK why it is returned as "_dev" ad not "is_dev"
                .andExpect(jsonPath("[1].id").value(2))
                .andExpect(jsonPath("[1].name").value("HR"))
                .andExpect(jsonPath("[1]._dev").value(false)) //IDK why it is returned as "_dev" ad not "is_dev"
